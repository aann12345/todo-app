  ...
  return (
    <div className="flex min-w-0 flex-1 items-center gap-1.5 overflow-x-auto">
      {workspaces.map((w) => {
        ...
        return (
          <button
            ...
            className={`flex shrink-0 items-center gap-1.5 rounded-full px-3.5 py-1.5 text-sm whitespace-nowrap transition ${
              active
      ...
      <button
        ...
        className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-surface-1 text-lg leading-none text-ink-dim transition hover:bg-surface-2 hover:text-accent"
